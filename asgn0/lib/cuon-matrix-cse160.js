...
class Vector3 {
    ...
    add(other) {
        ...
        this.elements = [this.elements[0] + other.elements[0], this.elements[1] + other.elements[1], this.elements[2] + other.elements[2]];
        return this;
    };
    ...
    div(scalar) {
        ...
        // Don't delete the return statement.
        this.elements = [this.elements[0] / scalar, this.elements[1] / scalar, this.elements[2] / scalar];
        return this;
    };
    ...
    static cross(other1, other2) {
        ...
        let second = 1;
        let third = 2;
        let el1 = (other1.elements[second]*other2.elements[third]) - (other1.elements[third]*other2.elements[second]);
        let el2 = (other1.elements[third]*other2.elements[first]) - (other1.elements[first]*other2.elements[third]);
        let el3 = (other1.elements[first]*other2.elements[second]) - (other1.elements[second]*other2.elements[first]);
        v3.elements = [el1, el2, el3];
        // Don't delete the return statement.
        return v3;
    }
    ...
    normalize() {
        ...
        this.elements = [this.elements[0]/magnitude, this.elements[1]/magnitude, this.elements[2]/magnitude];
        return this;
    };
}
